...
class PesertaDidikController extends Controller{
    ...
    function index(){
        ...
        return view('admin.pesertadidik.index', $data);
    }
    ...
    function store(){
        ...
        return redirect('admin/pesertadidik')->with('success', 'Data Berhasil Ditambahkan');
    ...
    function show($pesertadidik){
        ...
        return view('admin.pesertadidik.show', $data);
    ...
    function edit($pesertadidik){
        ...
        $data['pesertadidik'] = PesertaDidik::find($pesertadidik);
        return view('admin.pesertadidik.edit', $data);
    }
    ...
    function update(PesertaDidik $pesertadidik){
        ...
        return redirect('admin/pesertadidik')->with('success', 'Data Berhasil Diedit');
    ...
    public function cetak_pdf(PesertaDidik $pesertadidik)
    {
        ...
        return view('admin.pesertadidik.cetak_pdf', $data);
    }
