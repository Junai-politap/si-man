...
class PesertaDidikController extends Controller{
    ...
    function index(){
        ...
        return view('super-admin.pesertadidik.index', $data);
    }

    function create(){
       
        return view('super-admin.pesertadidik.create');
    ...
    function store(){
        ...
        return redirect('super-admin/peserta-didik')->with('success', 'Data Berhasil Ditambahkan');
    ...
    function show($pesertadidik){
        ...
        return view('super-admin.pesertadidik.show', $data);
        
    }

    function edit($pesertadidik){
       
        $data['pesertadidik'] = PesertaDidik::find($pesertadidik);
        return view('super-admin.pesertadidik.edit', $data);
    }
    ...
    function update(PesertaDidik $pesertadidik){
        ...
        return redirect('super-admin/peserta-didik')->with('success', 'Data Berhasil Diedit');
    ...
    function destroy($pesertadidik){
        ...
        return redirect('super-admin/peserta-didik')->with('danger', 'Data Berhasil Dihapus');
    ...
    public function cetak_pdf(PesertaDidik $pesertadidik)
    {
        ...
        return view('super-admin.pesertadidik.cetak_pdf', $data);
    }
