    ...
    <div class="container-fluid mt-2">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        <a href="{{ url('admin/data-cover/create') }}" class="btn btn-outline-success ">
                                    ...
                                    @foreach ($list_datacover as $datacover)
                                        <tr>
                                            ...
                                            <td class="text-center" width="250">
                                                <div class="btn-group">
                                                    <x-button.info-button url="admin/data-cover"
                                                        id="{{ $datacover->id }}" />

                                                    <x-button.edit-button url="admin/data-cover"
                                                        id="{{ $datacover->id }}" />

                                                    <x-button.delete-button url="admin/data-cover"
                                                        id="{{ $datacover->id }}" />
                                                </div>
                                            </td>
