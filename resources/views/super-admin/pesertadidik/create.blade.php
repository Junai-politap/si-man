<x-app>
                                        ...
                                        <div class="tab-content" id="custom-tabs-four-tabContent">
                                            <div class="tab-pane fade show active" id="custom-tabs-four-pesetadidik"
                                                ...
                                                <div class=" d-grid gap-2 d-md-flex justify-content-md-end">
                                                    ...
                                                    data-toggle="pill" href="#custom-tabs-four-datapindahan"
                                                    role="tab" aria-controls="custom-tabs-four-datapindahan"
                                                    aria-selected="false"><button class="btn btn-primary"  type="button"><i
                                                            class="fa fa-arrow-right" onclick="changeTab()"></i></button></a>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-grup">
                                                            <label for="">No.Ijazah</label>
                                                            <input type="text" class="form-control"
                                                                name="no_ijazah_akhir_pendidikan">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-grup">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                name="melanjutkan_ke_setelah_selesai_pendidikan">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-grup">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                name="mulai_bekerja_setelah_selesai_pendidikan">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-grup">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                name="nama_perusahaan_setelah_selesai_pendidikan">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-grup">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                name="penghasilan_setelah_selesai_pendidikan">
                                                        </div>
                                                    </div>
    ...
    <script>
        ...
        function changeTab(){
            var datapindahanTab = document.getElementById('custom-tabs-four-datapindahan-tab');
            datapindahanTab.click();
        }
    </script>
